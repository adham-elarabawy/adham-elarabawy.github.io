...
description: An open-source precision differential drivetrain with spline path following.
date: 2020-04-15
tags: ["robotics", "machine learning"]
image: /assets/projects/drivetrain-demo.gif
---

# Precision Drivetrain

<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain-demo.gif" alt="Alt text" title="Image Title" style="width: 350px;" />
</div>
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain_model.png" alt="Alt text" title="Image Title" style="width: 350px;" />
</div>

<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/final_drivetrain.JPG" alt="Alt text" title="Image Title" style="width: 350px; -webkit-transform: scaleX(-1); transform: scaleX(-1);" />
</div>
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain_top_board.jpg" alt="Alt text" title="Image Title" style="width: 200px;" />
</div>

<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain_bottom_board.jpg" alt="Alt text" title="Image Title" style="width: 200px;" />
</div>
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain_chart.png" alt="Alt text" title="Image Title" style="width: 300px;" />
</div>
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="/assets/projects/drivetrain_plot.png" alt="Alt text" title="Image Title" style="width: 300px;" />
</div>
